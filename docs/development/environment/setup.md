...
* You can use `grunt webpack:watch`, this command will watch for changes in the JavaScript files and keep them up-to-date. Please note that there is no development server in use, so you'll have to refresh the webpage yourself.
