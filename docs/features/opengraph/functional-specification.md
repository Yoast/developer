...
| `og:video:secure_url` | Legacy Facebook / Open Graph tag. As per `og:image:secure_url`, but for the featured video (in our [Video SEO for WordPress plugin](https://yoast.com/features/video-seo/)). | Yoast SEO v14.0 (Apr 2020) |
